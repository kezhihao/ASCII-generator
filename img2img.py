...
def get_args():
    ...
    parser.add_argument("--input", type=str, default="data/input_tingyu2.jpg", help="Path to input image")
    parser.add_argument("--output", type=str, default="data/output_tingyu2.jpg", help="Path to output text file")
